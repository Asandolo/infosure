...
export function Form ({ inputDefault, ...props }: MyFormProps) {
    return (
        <>
            <form {...props}>
                <div className="rounded-lg px-4 py-6">
                    <Input defaultValue={inputDefault} name='q' className="w-full text-gray-700 bg-gray-200 border border-gray-400 rounded-lg py-2 px-4 mb-4 leading-tight focus:outline-none focus:bg-white focus:border-blue-700"  />
